    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Tetap update dengan berita dan pengumuman terbaru
        </p>
      </div>
        ...
        <Card className="mb-8 border-l-4 border-l-purple-500">
          ...
          <CardContent>
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <Link
                href={`https://www.kompasiana.com/kkm64calungbungur/687b6a7aed64156bb3602862/observasi-mahasiswa-universitas-bina-bangsa-kesekolah-sd-1-calung-bungur-kec-sajira-lebak-banten?utm_source=Whatsapp&utm_medium=Refferal&utm_campaign=Sharing_Desktop`}
              >
                <Button>
                  Sumber Berita
